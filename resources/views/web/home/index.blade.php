                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img">
                                                            <a href="{{ route('home.show', $product->id) }}">
                                                                <img src="{{ asset('storage/product/' . $product->image) }}" onerror="this.onerror=null; this.src='https://placehold.co/600x600';" class="img-fluid w-100 rounded-top" alt="{{ $product->name }}">
