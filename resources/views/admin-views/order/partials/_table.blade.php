...
<tr class="status-{{$order['order_status']}} class-all">
    ...
    <td>
        <div class="btn--container justify-content-center">
            ...
            <a hidden class="ml-2 btn btn-sm btn--primary btn-outline-primary action-btn" href="{{route($parcel_order?'admin.order.generate-invoice':'admin.order.generate-invoice',['id'=>$order['id'],'module_id'=>$order['module_id']])}}">
                <i class="tio-print"></i>
            </a>
        </div>
    </td>
