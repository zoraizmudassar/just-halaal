...
@php($module_type = \App\CentralLogics\Helpers::get_store_data()->module->module_type)
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="item_form"
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4" id="organic">
                                    <div class="form-check mb-0 p-6">
                                        <input class="form-check-input" name="organic" type="checkbox" value="0" id="flexCheckDefault" checked>
                ...
                <div class="col-lg-12" id="food_variation_section" hidden>
                ...
                <div class="col-md-12" id="attribute_section" hidden>
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
