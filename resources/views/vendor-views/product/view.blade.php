                    ...
                    <table class="table table-borderless table-thead-bordered">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th hidden class="px-4 border-0"><h4 class="m-0 text-capitalize">{{translate('variations')}}</h4></th>
                                @if(\App\CentralLogics\Helpers::get_store_data()->module->module_type == 'food')
                                <th hidden class="px-4 border-0"><h4 class="m-0 text-capitalize">{{translate('addons')}}</h4></th>
                                @endif
                                <th hidden class="px-4 border-0">
