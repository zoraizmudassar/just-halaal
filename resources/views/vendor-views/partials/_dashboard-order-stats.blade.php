...
<div class="col-12">
    <div class="row g-2">
        ...
        <div class="col-sm-6 col-lg-4">
            <!-- Card -->
            <a class="resturant-card dashboard--card card--bg-4" href="{{route('vendor.order.list',['delivered'])}}">
                <h4 class="title">{{$data['delivered']}}</h4>
                <span class="subtitle">{{translate('messages.delivered')}}</span>
                <img src="{{asset('public/assets/admin/img/dashboard/statistics/1.png')}}" alt="img" class="resturant-icon">
            </a>
            <!-- End Card -->
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
            <!-- Card -->
            <a class="resturant-card dashboard--card card--bg-4" href="{{route('vendor.order.list',['all'])}}">
                <h4 class="title">{{$data['all']}}</h4>
                <span class="subtitle">{{translate('messages.all')}}</span>
                <img src="{{asset('public/assets/admin/img/dashboard/statistics/4.png')}}" alt="img" class="resturant-icon">
            </a>
            <!-- End Card -->
        </div>
