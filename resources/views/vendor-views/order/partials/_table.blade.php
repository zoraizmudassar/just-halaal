...
<tr class="status-{{$order['order_status']}} class-all">
    ...
    <td>
        <div class="btn--container justify-content-center">
            ...
            <a hidden class="btn btn-sm btn--primary btn-outline-primary action-btn" target="_blank" href="{{route('vendor.order.generate-invoice',[$order['id']])}}"><i class="tio-print"></i></a>
        </div>
    </td>
</tr>
@endforeach
