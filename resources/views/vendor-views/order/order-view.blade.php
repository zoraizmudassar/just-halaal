    ...
    <div class="content container-fluid">
        ...
        <div class="row" id="printableArea">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        <div class="order-invoice-left d-flex d-sm-flex justify-content-between">
                            ...
                            <div hidden class="d-sm-none">
                                <a hidden class="btn btn--primary print--btn font-regular"
                        ...
                        <div class="order-invoice-right mt-3 mt-sm-0">
                            <div hidden class="btn--container ml-auto align-items-center justify-content-end">
                                <a hidden class="btn btn--primary print--btn font-regular d-none d-sm-block"
                                    href={{ route('vendor.order.generate-invoice', [$order['id']]) }}>
                                    <i class="tio-print mr-sm-1"></i> <span>{{ translate('messages.print_invoice') }}</span>
                                </a>
                            </div>
            ...
            @endif
                ...
                <div class="card mb-2 mt-2">
                    <div class="card-header border-0 text-center pb-0">
                        <h4 class="m-0">Customer Identity </h4>
                        @if ($order['store']['self_delivery_system'])
                    ...
                    @php($data = isset($order->customer_identity_proof) ? json_decode($order->customer_identity_proof, true) : 0)
                    <div class="card-body pt-2">
                        @if ($data)
                        <label class="input-label"
                            for="customer_identity_proof">{{ translate('messages.image') }} : </label>
                        <div class="row g-3">
                                @foreach ($data as $key => $img)
                                    <div class="col-3">
                                        <img class="img__aspect-1 rounded border w-100" data-toggle="modal"
                                    ...
                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                        role="dialog" aria-labelledby="customer_identity_proof_{{ $key }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"
                                                        id="customer_identity_proof_{{ $key }}">
                                                        Customer Identity Proof</h4>
                                                    <button type="button" class="close"
                                                        data-dismiss="modal"><span
                                                            aria-hidden="true">&times;</span><span
                                                            class="sr-only">{{ translate('messages.cancel') }}</span></button>
