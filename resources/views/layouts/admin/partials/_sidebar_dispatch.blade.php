        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--8E78C7" id="navbar-vertical-content">
                ...
                @if (\App\CentralLogics\Helpers::module_permission_check('order'))
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{ Request::is("admin/dispatch/list/{$module->id}*") ? 'active' : '' }}">
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{ Request::is("admin/dispatch/parcel/list/{$module->id}*") ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{ $module->module_name }}">
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{ $module->module_name }}
                                <span class="badge badge-soft-light badge-pill ml-1">
