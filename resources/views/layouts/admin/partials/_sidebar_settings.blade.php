            ...
            <div class="navbar-vertical-content bg--8E78C7" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/module') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/business-settings/module*') ? 'block' : 'none' }}">
                        <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/module/create') ? 'active' : '' }}">
                ...
                <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/third-party*') || Request::is('admin/business-settings/fcm*') || Request::is('admin/business-settings/login-url-setup*') || Request::is('admin/business-settings/offline-payment*') ? 'active' : '' }}">
