<div id="sidebarMain" class="d-none">
    <aside
        ...
        <div class="navbar-vertical-container">
            ...
            <!-- Content -->
            <div class="navbar-vertical-content text-capitalize bg--8E78C7" id="navbar-vertical-content">
                <form class="sidebar--search-form" hidden>
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    <!-- Dashboards -->
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel')?'active':''}} mt-3">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/order*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('store-panel/order*')?'block':'none'}}">
                            ...
                            <li class="nav-item {{Request::is('store-panel/order/list/refunded')?'active':''}}" hidden>
                            ...
                            <li class="nav-item {{Request::is('store-panel/order/list/scheduled')?'active':''}}" hidden>
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/item/flash-sale*') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/item*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('store-panel/item*')?'block':'none'}}">
                            ...
                            <li hidden class="nav-item {{Request::is('store-panel/item/pending/item/list') ||  Request::is('store-panel/item/requested/item/view/*') ?'active':''}}">
                            ...
                            <li hidden class="nav-item {{  Request::is('store-panel/item/product-gallery') ? 'active' : '' }}">
                            ...
                            <li hidden class="nav-item {{Request::is('store-panel/item/stock-limit-list')?'active':''}}">
                            ...
                            <li hidden class="nav-item {{Request::is('store-panel/item/bulk-import')?'active':''}}">
                            ...
                            <li hidden class="nav-item {{Request::is('store-panel/item/bulk-export')?'active':''}}">
                ...
                <!-- End DeliveryMan -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/campaign*')?'active':''}}" hidden>
                ...
                <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/coupon*') ? 'active' : '' }}">
                <a class="js-navbar-vertical-aside-menu-link nav-link"
                ...
                <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/banner*') ? 'active' : '' }}">
                ...
                <!-- End Coupon -->
                    ...
                    <!-- Business Settings -->
                   <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/profile/bank-view')?'active':''}}">
                       <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/wallet')?'active':''}}">
                        ...
                        <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/withdraw-method*')?'active':''}}">
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/reviews')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/message*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('vendor/report/expense-report') ? 'active' : '' }}">
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/report/disbursement-report') ? 'active' : '' }}">
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/custom-role*')?'active':''}}">
                    ...
                    <li hidden class="navbar-vertical-aside-has-menu {{Request::is('store-panel/employee*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
